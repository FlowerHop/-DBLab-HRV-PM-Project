        ...
        <div>
          <div role="tabpanel">
            <ul style={{backgroundColor: '#083D77', color: '#F8FFF4',}} className="nav nav-pills" role="tablist">
              ...
              <li><a href="#hospitalWard" aria-controls="profile" role="tab" data-toggle="tab">Hospital Ward</a></li>
            ...
            <div className="tab-content">
              ...
              <div role="tabpanel" className="tab-pane" id="hospitalWard"><HospitalWard/></div>
