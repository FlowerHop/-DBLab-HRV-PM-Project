...
*******************************************************************************/
let LPFilterManager = require ('./LPFilter');
let HPFilterManager = require ('./HPFilter');
let MWIntegratorManager = require ('./MWIntegrator');
let DerivManager = require ('./Deriv');
...
(function () {
    ...
    module.exports = QRSFilterManager;
})();
